...
{
    public class DepoIdResolver : IValueResolver<UrunlerDto, Urunler, int?>
    {
        private readonly IUrunlerDal _urunlerDal;

        public DepoIdResolver(IUrunlerDal urunlerDal)
        {
        ...
        {
            return _urunlerDal.GetDepoId(source.DepoAdi).Result;
        }
    }
}
